...
class Rweek_model extends CI_Model
{
	...
	function getjadwal($data){
		...
		//$query = $this->db->query("select Tanggal,Jam,Tujuan,Tdriver.Nama as driver, user.nama as pengguna from Tschedule,Tdriver,user where Tschedule.iddriver=Tdriver.iddriver and Tschedule.User = user.id and Tschedule.status=1 and " .$kondisi );
	 	 ...
	 	 $this->db->select('Tanggal,Jam,Tujuan,tdriver.Nama as Driver, user.nama as pengguna');
		$this->db->from('tschedule');
		$this->db->join('tdriver','tschedule.iddriver = tdriver.iddriver');
		$this->db->join('user','tschedule.user = user.id');
...
/* End of file Rweek_model.php */
/* Location: ./application/models/Rweek_model.php */
